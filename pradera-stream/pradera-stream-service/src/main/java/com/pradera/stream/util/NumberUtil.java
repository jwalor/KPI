...
public class NumberUtil extends NumberUtils {
	...
	public static boolean isDecimal(String cad) {
		...
		boolean hayPunto=false;
		 ...
		 char _charComma = ',';
		 //Si alguno de los caracteres de la parte entera no son digitos no es decimal ni "," 		 
		 for(i = 0; i<parteEntera.length(); i++)
		 if( ! Character.isDigit(parteEntera.charAt(i)) && _charComma  !=Character.valueOf(parteEntera.charAt(i)) )    
		 return false;
