...
public class PopulateSettlement extends PopulateCollection {
	...
	public void createExecutions() throws IOException  {
		...
		String _topologyName = "settlementTopology";
		 ...
		 *  Delete executions 
		 */
		Bson filter = Filters.regex("name", "_Settlement");
		 ...
		 *  Delete topology 
		 */
		filter = Filters.regex("name", "settlementTopology");
		mongoDBClient.delete(filter, "topology");
