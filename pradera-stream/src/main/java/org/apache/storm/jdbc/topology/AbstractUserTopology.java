...
public abstract class AbstractUserTopology {
    ...
    public void execute(String[] args) throws Exception {
        ...
        /**
         *  Map  mapMongo = new HashMap<String,Object>();
	        mapMongo.put("USER", "qsi_batch");
	        mapMongo.put("PASSWORD", "5xhThr4NHWVn");
	        mapMongo.put("DB", "qsi_batch");
	        mapMongo.put("HOST", "ndc-pfv-mongodb3.qualifacts.com");
	        mapMongo.put("PORT", (int)27000);
	        
	        config.put("CREDENTIALS_MONGO", mapMongo);
