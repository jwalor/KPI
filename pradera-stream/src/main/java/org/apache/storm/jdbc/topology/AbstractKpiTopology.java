 ...
 *
 */
public abstract class AbstractKpiTopology  {
...
//         connectionProviderTarget.prepare();
         ...
         JdbcClient jdbcClient = null;//new JdbcClient(connectionProviderTarget, queryTimeoutSecs);
...
//         connectionProviderTarget.cleanup();
         ...
         cluster.submitTopology(topoName, config, null);
